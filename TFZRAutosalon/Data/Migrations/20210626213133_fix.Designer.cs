            ...
            modelBuilder.Entity("TFZRAutosalon.Models.Cars", b =>
                {
                    ...
                    b.Property<int>("CarModelId")
                        .HasColumnName("FK_CarModels_Cars")
                        .HasColumnType("int");

                    b.Property<int>("CategoryId")
                        .HasColumnName("FK_Category_Cars")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FK_CarManufacturers_Cars")
                        .HasColumnName("FK_CarManufacturers_Cars1")
                        .HasColumnType("int");

                    b.Property<int?>("FK_CarModels_Cars")
                        .HasColumnName("FK_CarModels_Cars1")
                        .HasColumnType("int");

                    b.Property<int?>("FK_Category_Cars")
                        .HasColumnName("FK_Category_Cars1")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ManufacturersId")
                        .HasColumnName("FK_CarManufacturers_Cars")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TFZRAutosalon.Models.Cars", b =>
                {
                    ...
                    b.HasOne("TFZRAutosalon.Models.Categorizes", "Categoriz")
                        .WithMany()
                        .HasForeignKey("FK_Category_Cars");
                });
